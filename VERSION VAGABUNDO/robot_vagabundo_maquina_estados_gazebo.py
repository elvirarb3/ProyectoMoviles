...
def main():
    ...
    sm = smach.StateMachine(outcomes=['bien', 'colision'])
    ...
    with sm:
        ...
        smach.StateMachine.add('DERECHA', Derecha(), transitions={'vagabundo':'VAGABUNDO'})
        smach.StateMachine.add('IZQUIERDA', Izquierda(), transitions={'vagabundo':'VAGABUNDO'})
        smach.StateMachine.add('PARAR', Parar(), transitions={'vagabundo':'VAGABUNDO', 'senyal':'SENYAL'}, remapping={'entrada':'stop'})
